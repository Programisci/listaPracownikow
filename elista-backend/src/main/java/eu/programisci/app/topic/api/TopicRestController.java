...
public class TopicRestController {
    ...
    public TopicDTO findOne(@RequestParam("id") Long aId) {
        return topicService.findOne(aId);
    }

    @RequestMapping(value = "/findAll", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public List<TopicDTO> findAll() {
        return topicService.findAllForTable();
    }
    ...
    public TopicDTO save(@RequestBody TopicDTO aTopicDTO) {
        return topicService.save(aTopicDTO);
    }
